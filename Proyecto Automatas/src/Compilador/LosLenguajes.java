...
public class LosLenguajes implements LenguajesProyConstantes {

static ArrayList<ElIdentificador> Datos =  new ArrayList<ElIdentificador>(); 
  public static void main(String args []) throws ParseException
  {
    
     try {
    	 
      LosLenguajes analizador = new LosLenguajes(System.in);
      analizador.Programa();
...
for (int i = 0; i < Datos.size(); i++) {
  ...
  static final public void DeclaradorVariable(String tipo) throws ParseException {
    ...
    case INTEGER_LITERAL:
     Datos.add(new ElIdentificador(identifi,jj_consume_token(INTEGER_LITERAL).image,tipo));
      break;
    case TRUE:
    case FALSE:
    	Datos.add(new ElIdentificador(identifi, boolean_literal(),tipo));
      break;
    default:
      jj_la1[3] = jj_gen;
      jj_consume_token(-1);
  ...
  static public LenguajesProyManejadorDeTokens token_source;
  ...
  public LosLenguajes(java.io.InputStream stream) {
     this(stream, null);
  }
  /** Constructor with InputStream and supplied encoding */
  public LosLenguajes(java.io.InputStream stream, String encoding) {
    ...
    token_source = new LenguajesProyManejadorDeTokens(jj_input_stream);
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Constructor. */
  public LosLenguajes(java.io.Reader stream) {
    if (jj_initialized_once) {
      System.out.println("ERROR: Second call to constructor of static parser. ");
      System.out.println("       You must either use ReInit() or set the JavaCC option STATIC to false");
      System.out.println("       during parser generation.");
  ...
  public LosLenguajes(LenguajesProyManejadorDeTokens tm) {
    if (jj_initialized_once) {
      System.out.println("ERROR: Second call to constructor of static parser. ");
      System.out.println("       You must either use ReInit() or set the JavaCC option STATIC to false");
      System.out.println("       during parser generation.");
  ...
  /** Reinitialise. */
  public void ReInit(LenguajesProyManejadorDeTokens tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
